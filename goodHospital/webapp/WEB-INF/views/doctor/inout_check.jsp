		              ...
		              <div class="card-header">
		                ...
		                <div class="card-tools">
		                  <div class="input-group input-group-sm" style="width: 150px;">
		                    <input type="text" name="table_search" class="form-control float-right" placeholder="환자번호를 입력해주세요.">
					...
					<table class="table table-hover">
						...
						<tbody>
							<tr>
								...
								<td><div class="text-muted text-nowrap">김수환</div></td>
								<td><div class="text-muted text-nowrap">의료보험</div></td>
							...
							<tr>
								...
								<td><div class="text-muted text-nowrap">정형외과</div></td>
								<td><div class="text-muted text-nowrap">김수환</div></td>
								<td><div class="text-muted text-nowrap">산재보험</div></td>
								<td><div class="actions">
										<a class="btn btn-info btn-sm" href="edit_appointment"> <i
											class="fas fa-pencil-alt"> </i>
										</a> <a class="btn btn-danger btn-sm" href="#"> <i
