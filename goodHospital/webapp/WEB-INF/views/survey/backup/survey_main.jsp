...
<div id="header-wrapper">
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				<li class="active"><a href="mainPage" accesskey="1" title="">Homepage</a></li>				
...
<div id="wrapper">
	<div id="staff" class="container">	
		...
		<div class="boxA"><img src="${pageContext.request.contextPath}/resources/img/depression1.jpg" width="300" height="450" alt="" /></div>
		<div class="boxB"><img src="${pageContext.request.contextPath}/resources/img/depression2.jpg" width="300" height="450" alt="" /></div>
		<div class="boxC"><img src="${pageContext.request.contextPath}/resources/img/depression3.jpg" width="300" height="450" alt="" /></div>		
		<div class="boxD"><img src="${pageContext.request.contextPath}/resources/img/bipolarDisorder1.png" width="300" height="450" alt="" /></div>
		<div class="boxE"><img src="${pageContext.request.contextPath}/resources/img/bipolarDisorder2.png" width="300" height="450" alt="" /></div>
		<div class="boxF"><img src="${pageContext.request.contextPath}/resources/img/bipolarDisorder3.png" width="300" height="450" alt="" /></div>
	...
	<div id="page" class="container">
		<div class="boxA">
			...
			<p>스트레스에 대한 반응으로
				...
				<center><input type="button" onclick="location.href='survey_depression'" value="우울증진단하러가기"></input></center>
		...
		<div class="boxD">
			...
			<center><input type="button" onclick="location.href='survey_manicDepression'" value="조울증진단하러가기"></input></center>
		</div>
		<div class="boxE">
			<h2>▶조울증의원인?
				</h2>
