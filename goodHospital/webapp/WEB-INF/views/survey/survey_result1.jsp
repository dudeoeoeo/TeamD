...
<head>
    ...
    <link href="/resources/css/ddmenu.css" rel="stylesheet" type="text/css" />
    <script src="/resources/js/ddmenu.js" type="text/javascript"></script>
    <style>
        /*The following are for this demo page only (not required for the ddmenu).*/
        body { background: #eee url(/resorces/img/ddmenu-bg.jpg) no-repeat center 0px; padding-top:90px;}
    </style>
